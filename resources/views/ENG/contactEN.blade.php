...
<body>
    <div id="boite" class="blueBox">
        <form class="col-6 col-10-sm mx-auto">
            ...
            <div class="col-6 mb-3">
                <label for="exampleInputPassword1" class="form-label">RE:</label>
            ...
            <div class="mb-3  form-check">
                ...
                <label class="form-check-label" for="exampleCheck1">I agree to <a href="{{asset('cgv')}}">General terms of sales
                        and general terms of use</a></label>
            </div>
            <button type="submit" id="submitContact" class="btn btn-primary">Sen</button>

        </form>
    </div>
    <div class="col-5 mt-5 mb-4 mx-auto">
        <h2>Or on our social networks</h2>
    </div>
