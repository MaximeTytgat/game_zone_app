...
<body>
    ...
    <div class="containerPlan">
        <div class="icon">
            <p>
                <ul class="iconPlan">
                    <li><img src="{{asset('images/iconPlanBlack.png')}}" alt="">Restaurants</li>
                    <li><img src="{{asset('images/iconPlanYellow.png')}}" alt=""> Photo spot </li>
                    <li><img src="{{asset('images/iconPlanBlue.png')}}" alt="">Shops</li>
                    <li><img src="{{asset('images/iconPlanPink.png')}}" alt="">Our services</li>
                </ul>
            </p>
        </div>
        <div class="map">
