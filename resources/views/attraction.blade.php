...
<body>
    ...
    <div class="boxBlue">
        <div class="containerRight">
            ...
            <p>
                <strong>Fighter Hard Team</strong><br>
                <br>
            ...
            <a class="more_infos_right" href="#">En savoir plus</a>
        </div>
    </div>
    ...
    <div class="boxBlue">
        <div class="containerRight">
            ...
            <p>
                <strong>Super Fighter League</strong><br>
                <br>
                <strong>Gain XP : 1000 XP / partie</strong> <br>
                <br>
    ...
    <div class="boxBlue">
        <div class="containerRight">
            ...
            <p>
                <strong>Champions League Survivor</strong><br>
                <br>
                <strong>Gain XP : 1300 XP / partie</strong> <br>
                <br>
                <strong>Accessible à tous</strong> <br>
